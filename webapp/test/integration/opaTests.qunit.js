...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "zqmfgcoa/test/integration/FirstJourney",
    "zqmfgcoa/test/integration/HeaderListJourney",
    "zqmfgcoa/test/integration/HeaderObjectPageJourney",
    "zqmfgcoa/test/integration/CharObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
